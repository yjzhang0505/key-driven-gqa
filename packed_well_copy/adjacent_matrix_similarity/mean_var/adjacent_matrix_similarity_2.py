...
plot_adjacency_matrix_graph(adj_matrix_1, "adj_matrix_1", iteration="initial", output_dir="/data/yjzhang/desktop/try/not_share/key-driven-gqa/figure/adjacent_matrix_2/figure")
...
# 设置保存文件的基础目录
output_dir = '/data/yjzhang/desktop/try/not_share/key-driven-gqa/figure/adjacent_matrix_2/files'
figure_dir = '/data/yjzhang/desktop/try/not_share/key-driven-gqa/figure/adjacent_matrix_2/figure'
