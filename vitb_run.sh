...
do
    ...
    # 构建并打印命令
    command="python /data/yjzhang/desktop/try/not_share/key-driven-gqa/train_freeze.py --file_path ${file_path}"
...
gqa_command="python /data/yjzhang/desktop/try/not_share/key-driven-gqa/train_freeze_gqa.py"
