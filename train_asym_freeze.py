...
# # 冻结每层 Attention 的 q 参数
# for i, block in enumerate(model.blocks):
#     # 获取 Attention 层
#     attention_layer = block.attn
#     # 冻结 q 参数
#     attention_layer.q.weight.requires_grad = False
#     attention_layer.q.bias.requires_grad = False

# 查看每个参数的 requires_grad 状态
...
new_file_name = file_name.replace('group_', 'Result_')  # 替换部分
