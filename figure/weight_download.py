...
def plot_k_weights_heatmaps(k_file, num_heads, dim, output_image_path, target_sum=1.0):
    ...
    for i in range(num_heads):
        ...
        # 对缩放后的数据应用指数函数 e^x
        exp_head_data = torch.exp(100*scaled_head_data)
...
k_file = '/data/yjzhang/desktop/try/key-driven-gqa/data/download/k_weights.txt'
num_heads = 12  # 假设有12个头
dim = 768       # 假设每个头的维度为768

# 输出图片路径
output_image_path = '/data/yjzhang/desktop/try/key-driven-gqa/data/download/k_weights_colorbar_heatmap.png'
