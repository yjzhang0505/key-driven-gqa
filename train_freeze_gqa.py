...
root = '/home/yjzhang/desktop/try/not_share/key-driven-gqa/cifar100'
...
# 配置 logging
logging.basicConfig(
    filename="/home/yjzhang/desktop/try/not_share/key-driven-gqa/output/dustbin2/gqa/Result_proxy=1.txt",  # 输出到的文件
